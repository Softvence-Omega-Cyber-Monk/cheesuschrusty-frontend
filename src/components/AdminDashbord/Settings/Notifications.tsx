...
const NotificationItem: React.FC<{
    ...
    <div className="flex items-center justify-between">
        <div>
            <h4 className="text-sm font-medium text-slate-800 dark:text-gray-100">{title}</h4>
...
const Notifications: React.FC = () => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-sm border border-slate-200 dark:border-gray-700 transition-colors">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-gray-100">Notification Settings</h2>
            <p className="text-slate-500 dark:text-gray-400 mt-1 text-sm">Configure system notifications and alerts</p>

            <div className="mt-8 space-y-8 divide-y divide-slate-200 dark:divide-gray-700">
                <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-gray-100">Email Notifications</h3>
                    <NotificationItem
                ...
                <div className="pt-8 space-y-4">
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-gray-100">User Communication</h3>
                    <NotificationItem
                        title="Welcome Email"
