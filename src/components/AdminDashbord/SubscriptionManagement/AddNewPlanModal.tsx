...
const AddNewPlanModal: React.FC<AddNewPlanModalProps> = ({ onClose, onAddPlan }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-lg m-4 transform transition-all duration-300 scale-95"
        onClick={(e) => e.stopPropagation()}
      >
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Add New Plan</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative mt-1">
                ...
                <input
                    ...
                    placeholder="0.00"
                    className="block w-full rounded-md border border-gray-300 py-2 pl-7 pr-12 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    required
                    min="0"
                    step="0.01"
                />
          ...
          <div>
            <label htmlFor="feature" className="block text-sm font-medium text-gray-700">Plan Feature</label>
          ...
          {features.length > 0 && (
            <div className="pt-2">
                <p className="text-sm font-medium text-gray-700 mb-2">Added features:</p>
