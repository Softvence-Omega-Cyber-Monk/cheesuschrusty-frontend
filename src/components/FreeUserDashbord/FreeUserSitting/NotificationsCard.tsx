...
const NotificationsCard: React.FC = () => {
  ...
  const NotificationItem: React.FC<{ title: string; desc: string; checked: boolean; onChange: (c: boolean) => void }> = ({ title, desc, checked, onChange }) => (
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow">
      ...
      <p className="text-sm text-gray-500 mb-4">Control your notification preferences</p>
